...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:HIG-Run3Summer22EEwmLHEGS-00605.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/HIG-Run3Summer22EEwmLHEGS-00605-fragment.py nevts:-1'),
